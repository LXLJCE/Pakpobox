...
//        titleScrollView.backgroundColor = [UIColor cz_colorWithRed:120 green:180 blue:230];
...
- (void)viewDidLayoutSubviews
{
    ...
    if (_isInitial == NO) {
        ...
        if (_isfullScreen) {
            ...
            // 顶部标题View尺寸
//            self.titleScrollView.frame = CGRectMake(0, titleY, YZScreenW, 100);
            self.titleScrollView.frame = CGRectMake(0, titleY, YZScreenW, 44);
...
//        label.frame = CGRectMake(labelX, (100 - labelH) / 2, labelW, labelH);
        label.frame = CGRectMake(labelX, (44 - labelH) / 2, labelW, labelH);
        // 监听标题的点击
...
//    self.underLine.yz_y = (100 - label.yz_height) / 2  + label.yz_height - underLineH;
    self.underLine.yz_y = (44 - label.yz_height) / 2  + label.yz_height - underLineH;
